...
export class HomeService {
  ...
  private readonly rootAssetPath = "/OpenRealEstatePlayground"
  ...
  private profilePictures = [
    this.rootAssetPath + '/assets/profiles/p1.jpg',
    this.rootAssetPath + '/assets/profiles/p2.png',
    this.rootAssetPath + '/assets/profiles/p3.png',
    this.rootAssetPath + '/assets/profiles/p4.png',
    this.rootAssetPath + '/assets/profiles/p5.png',
    this.rootAssetPath + '/assets/profiles/p6.jpg',
    this.rootAssetPath + '/assets/profiles/p7.jpg',
    this.rootAssetPath + '/assets/profiles/p8.jpg',
    this.rootAssetPath + '/assets/profiles/p9.jpg',
    this.rootAssetPath + '/assets/profiles/p10.jpg',
    this.rootAssetPath + '/assets/profiles/p11.jpg',
    this.rootAssetPath + '/assets/profiles/p12.jpg',
    this.rootAssetPath + '/assets/profiles/p13.jpg',
    this.rootAssetPath + '/assets/profiles/p14.jpg',
    this.rootAssetPath + '/assets/profiles/p15.jpg',
    this.rootAssetPath + '/assets/profiles/p16.jpg',
    this.rootAssetPath + '/assets/profiles/p17.jpg',
    this.rootAssetPath + '/assets/profiles/p18.jpg',
